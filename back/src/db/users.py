...
def update_user(old_user_mail: str, user_mail: str = None, user_password: bytes = None, user_name: str = None) -> bool:
...
def get_users() -> Union[List, None]:
    return DB().execute("""SELECT user_mail, user_name FROM Users""",
                        keys=("mail", "name"))
